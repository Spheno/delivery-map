...
export function NewDeliveryForm({ isOpen, onClose }) {
  ...
  /*
  let el = document.getElement('.map__plan');
  ...
  return (
    ...
    >
      ...
      <div className="form__button-container">
        <button className={`form__button-submit form__button-submit_type_new-delivery ${isValid ? 'hover-button' : 'button__disabled'}`} type="submit"
